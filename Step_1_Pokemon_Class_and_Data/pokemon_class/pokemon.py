"""
Step 1: Introduction to the Pokemon Class
==========================================
This module introduces students to:
- Class definition and __init__ method
- Instance variables (attributes)
- Using dictionaries to store moves/abilities
- Basic methods

A Pokemon has:
- Basic stats (HP, Attack, Defense, Speed, Special Attack)
- A set of 4 moves/abilities with Power and Accuracy
- Current HP (for battle)
"""
