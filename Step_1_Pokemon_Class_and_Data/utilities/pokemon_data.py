"""
Step 1: Pokemon Database
========================
This module contains:
- Predefined Pokemon data (using dictionaries and lists)
- Move definitions
...
- Data organization
- Using dictionaries as databases
"""

# Predefined Moves - Each move is a dictionary with properties
MOVES = {
    "Tackle": {
        "power": 40,
        "accuracy": 100,
...
# Predefined Pokemon - Each Pokemon has stats and move set
POKEMON_DATABASE = {
    "Charizard": {
        "level": 50,
        "type": "fire",
...
# Type advantage: attacking_type -> {defending_type: multiplier}
TYPE_EFFECTIVENESS = {
...
def get_pokemon_data(pokemon_name):
    """Get a Pokemon's base data from the database."""
    return POKEMON_DATABASE.get(pokemon_name, None)

def get_move_data(move_name):
    """Get a move's data from the moves database."""
    return MOVES.get(move_name, None)

def get_random_pokemon():
    """Return a random Pokemon name from the database."""
    import random
